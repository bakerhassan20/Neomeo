            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{URL::asset('assets/img/user_img/'. Auth::user()->img)}}"><span
            ...
            <li class="slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices')) }}">main category</a></li>



                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}">sub category</a>
                        </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">Specializations</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_report')) }}">Specializations</a>
                            </li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">All users</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                           <li><a class="slide-item" href="{{ route('admins.index') }}">Admin</a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">Users</a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">Doctors</a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">Patient</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">General </span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">Rating</a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">Reviews</a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">Questions</a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">Contact Us</a></li>
